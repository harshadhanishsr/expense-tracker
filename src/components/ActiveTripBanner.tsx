...
export default function ActiveTripBanner() {
  ...
  return (
    <Link href={`/trips/${activeTrip.id}`}
      className="block mx-4 mb-4 rounded-2xl border border-indigo-500/40 p-4
        bg-gradient-to-br from-indigo-500/12 to-violet-500/6">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-[10px] text-indigo-400 uppercase tracking-widest mb-1 flex items-center gap-1">
            <span className="w-1.5 h-1.5 rounded-full bg-indigo-500" /> Live Trip
          </div>
